...
const Hero = () => {
  return (
    <main id="home" className="hero-pattern min-h-screen bg-[#021d20] pt-24 text-white" dir="rtl">
      <Container>
        <section className="grid min-h-[calc(100vh-6rem)] items-center gap-10 py-16 lg:grid-cols-2 lg:gap-20">
          <div className="order-2 text-center lg:order-1 lg:text-right">
            ...
            <h1 className="text-3xl font-black leading-[1.5] sm:text-4xl xl:text-5xl">قدرت‌بخش کسب‌وکارهای هوشمند</h1>
